    ...
    <IonPage>
        ...
        <IonToolbar color="white">
          <IonTitle className="font-weight-bold">
            <IonIcon
              ...
              className="mr-2 align-text-top text-dark"
      ...
      <IonContent fullscreen>
        <Container fluid={true} className="my-3 pb-6">
          ...
          <small className="text-default font-weight-bold">
            Select a address to mark it as default
          </small>
          <Row className="my-2">
        ...
        <Button
          className="position-fixed fixed-bottom w-100 bg-success p-3 m-0 text-white"
          href="/add-address"
        >
          Add new Address
        </Button>
